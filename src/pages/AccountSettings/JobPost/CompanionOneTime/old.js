...
export default function CompanionOneTime() {
  ...
  const getViewed = async () => {
    try {
      const respJSON = await fetch(`https://api.ongstercare.com/get-viewed-profiles/${user.id}`);
      const resp = await respJSON.json();
      if (resp.success) {
  ...
  const handleAllCareseeker = async () => {
    try {
      const respJSON = await fetch(`https://api.ongstercare.com/get-careseeker-main-dashboard`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          zipCode: 1234,
  ...
  return (
    <div>
          ...
          <div className="d-none d-sm-block">
            <div className="d-flex    ">
              <div
                // flex-lg-nowrap
                // flex-sm-wrap
                className={`d-flex   mx-auto my-2 bg-white p-2 align-items-center ${/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? "w-100" : "w-50"}`}
              >
                ...
                <span className="w-100">
                  <StandardSelect
                    ...
                    dropOptions={["Child care", "Special needs", "Senior care ", "Tutoring & lessons", "Pet care ", "Errands & odd jobs"]}
                  />
                </span>
                <span className="px-3">
                  <StandardSelect
                    label="Within"
                    dropOptions={["5 miles", "10 miles", "15 miles", "20 miles", "25 miles", "30 miles", "35 miles", "40 miles", "45 miles", "50 miles"]}
          ...
          <div className="d-block d-sm-none">
            ...
            <div className="d-flex d-none    ">
              <div
                // flex-lg-nowrap
                // flex-sm-wrap
                className={`d-flex  flex-wrap  mx-auto my-2 bg-white p-2 align-items-center ${/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? "w-100" : "w-50"}`}
              >
                <div className="pl-3" style={{ marginTop: 20 }}>
      ...
      <div className="w-100  ">
        ...
        <div className="position-absolute text-white banner" style={{ position: "absolute", bottom: "40%", left: "30%" }}>
      ...
      <Container className="d-flex justify-content-center">
        <div
          style={{
            ...
            alignItems: "center",
            marginTop: "3%",
            boxShadow: "#0000008c 0px 1px 13px 0px",
            position: "absolute",
            top: "64%",
            flexDirection: "row",
          }}
        ...
        >
          ...
          >
            ...
            <div className="w-50 " style={{ backgroundColor: "lightblue", borderRadius: 10 }}>
              <br />
      ...
      <Container className="d-flex justify-content-center">
        <Col className="d-none d-sm-block" xs={9} md={7} style={{ marginLeft: 280 }}>
          <Form.Group controlId="" className="mx-3">
            <Form.Control type="text" placeholder="6055" className="w-50 p-4" />
          </Form.Group>
        </Col>

        <Col className="d-block d-sm-none" xs={9} md={7} style={{ marginLeft: 0 }}>
          <Form.Group controlId="" className="mx-3">
            <Form.Control type="text" placeholder="6055" className="w-100 p-4" />
          </Form.Group>
        </Col>
      </Container>
      <Container className="d-flex justify-content-center">
      ...
      <Container className="d-flex justify-content-center">
        <Row style={{ marginTop: 75 }}>
          ...
          />
          <h5 style={{ fontSize: 35, marginRight: 20, marginLeft: 20 }}> {count} </h5>
          <img
            src={plus}
            width={50}
            height={50}
      ...
      <Container style={{ marginTop: 20 }} className="d-flex justify-content-center">
      ...
      <Container className="d-flex justify-content-center">
        <h6 style={{ marginTop: 25 }}>Ensure Kids Attend their School's online classes and keep up your Assignments</h6>
      </Container>
      <Container className="d-flex justify-content-center">
        <Row style={{}}>
          <img src={circle} />
      ...
      <Container className="d-flex justify-content-center">
        <h3 style={{ marginTop: 70 }}>How much you would like to pay per Hours</h3>
      </Container>
      <Container className="d-flex justify-content-center">
        <h6 style={{ marginTop: 25 }}>$11.48 is the Average in your Area.pay range Start at your Area's minimum wage.</h6>
      </Container>
      <Container>
        <LargeRangeSlider title="Select Hourly Rates" value={value1} setValue={setValue1} />
      </Container>
      <Container>
        <hr />
      </Container>
