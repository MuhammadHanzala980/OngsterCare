...
//       <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Benefits Program</h1>
...
export default function Benefits({ careSeeker, setCareSeeker }) {
