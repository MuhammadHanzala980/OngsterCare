...
//       <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Home Pay</h1>
...
export default function HomePay({ careSeeker, setCareSeeker }) {
