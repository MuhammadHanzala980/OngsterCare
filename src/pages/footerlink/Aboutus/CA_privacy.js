...
// export default function CA_Privacy() {
...
//       <h1  style={{textAlign: 'center',marginTop:50 , border:"3px solid black"  , backgroundColor:'lightblue'}}> F. A Privacy</h1>
...
export default function CA_Privacy({ careSeeker, setCareSeeker }) {
...
const handleOpen = () => {
  ...
  return (
    <div>
      ...
      <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Careers</h1>
      <div style={{marginTop:"20%"}}>
      <Footer/>
