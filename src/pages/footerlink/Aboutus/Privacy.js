...
//       <h1  style={{textAlign: 'center',marginTop:50 , border:"3px solid black"  , backgroundColor:'lightblue'}}>Privacy</h1>
...
export default function Privacy({ careSeeker, setCareSeeker }) {
...
const handleOpen = () => {
  ...
  return (
    <div>
      ...
      <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Privacy Policy</h1>
      <div style={{marginTop:"20%"}}>
      <Footer/>
