...
//       <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Help and FAQS</h1>
...
export default function Help({ careSeeker, setCareSeeker }) {
