...
//       <h1  style={{textAlign: 'center' , border:"3px solid black"  , backgroundColor:'lightblue' , marginTop:50}}>Saftey Center</h1>
...
export default function Saftey({ careSeeker, setCareSeeker }) {
